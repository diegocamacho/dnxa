var ComponentsDateTimePickers = function () {
    ...
    var handleDatetimePicker = function () {
		...
		*/
        ...
        $( document ).scroll(function(){
            $('#form_modal1 .form_datetime, #form_modal1 .form_advance_datetime, #form_modal1 .form_meridian_datetime, #form_modal1 .form_meridian_datetime_2').datetimepicker('place'); //#modal is the id of the modal
        });
    }
