...
if(!$id) exit("No llegó el identificador del evento.");
...
$sq=@mysql_query("DELETE FROM citas WHERE id_evento=$id");
if(!$sq) $error = true;

$sq=@mysql_query("DELETE FROM eventos WHERE id_evento=$id");
if(!$sq) $error = true;
