...
$link_xml = 'download_xml.php';
$link_pdf = 'download_pdf.php';
...
//getPath($config->ruta_local_emitidos,$s_id_empresa,$uuid);	
...
?>	
	<div class="modal-footer">
		<a role="button" data-log="14" class="log btn red-thunderbird" href="<?=$link_xml?>?id_factura=<?=$id_factura?>" >Descargar XML</a>
		<a role="button" data-log="13" class="log btn red-thunderbird" href="<?=$link_pdf?>?id_factura=<?=$id_factura?>" >Descargar PDF</a>
